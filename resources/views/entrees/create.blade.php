@extends('layouts.app')
@section('titre', 'Nouvelle Entrée Stock')

@section('content')
<div class="card" style="max-width:600px">
    <div class="card-header">
        <i class="fas fa-arrow-circle-down text-success me-2"></i>Nouvelle Entrée de Stock
    </div>
    <div class="card-body">
        <form action="{{ route('entrees.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="quantite" min="1"
                       ...
                       value="{{ old('quantite') }}" placeholder="Ex: 10">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="prix_unitaire" step="0.01"
                       ...
                       value="{{ old('prix_unitaire') }}" placeholder="Ex: 150000">
                @error('prix_unitaire')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="mb-3">
                <label class="form-label fw-semibold">Date d'entrée <span class="text-danger">*</span></label>
